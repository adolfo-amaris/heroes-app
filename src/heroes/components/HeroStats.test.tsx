...
const mockUseHeroSummmary = vi.mocked(useHeroSummary)
...
const renderHeroStats = (mockData?: Partial<SummaryInformationResponse>) => {
    ...
    mockUseHeroSummmary.mockReturnValue({
...
describe('HeroStats', () => {
    ...
    test('should change the percentage of favorites when a hero is added to favoites', () => {
        ...
        const favoriteCountElementt = screen.getByTestId('favorite-count');
        expect(favoriteCountElementt.innerHTML).toContain('1');
