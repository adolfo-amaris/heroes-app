        ...
        <>
            <div className="flex flex-col lg:flex-row gap-4 mb-8">
                ...
                <div className="relative flex-1">
                    ...
                    <Input
                        ref={inputRef} // ! forma mejorada o de hacerla con react
                ...
                <div className="flex gap-2">
                    <Button variant="outline" className="h-12"
                        onClick={() => {
                            if (activeAcordion === 'advanced-filter') {
                    ...
                    <Button variant={activeAcordion === "advanced-filter" ? 'default' : 'outline'} className="h-12">
            ...
            <Accordion type="single" collapsible value={activeAcordion} data-testid='accordion'>
